...
def start_button(client):
    ...
    if FORCE_SUB_CHANNEL and FORCE_SUB_CHANNEL2 and FORCE_SUB_GROUP:
        buttons = [
            [
                InlineKeyboardButton(text="ᴄʜᴀɴɴᴇʟ ᴜᴛᴀᴍᴀ", url=f"https://t.me/kode_nuklir_nekopoi"),
                InlineKeyboardButton(text="ᴄʜᴀɴɴᴇʟ ʟᴀɪɴɴʏᴀ", url=f"https://t.me/ListViral"),
            ],
            [
                InlineKeyboardButton(text="ʟɪᴠᴇ sʜᴏᴡ ʙᴀʀ-ʙᴀʀ", url=f"https://t.me/live_colmek"),
            ],
            [InlineKeyboardButton(text="ᴠᴄs ʀᴇᴀʟ [ᴏᴘᴇɴ 𝟸𝟺 ᴊᴀᴍ]", url=f"https://t.me/info_vcs")],
        ]
        return buttons
